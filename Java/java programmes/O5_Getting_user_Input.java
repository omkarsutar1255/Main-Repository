...
public class O5_Getting_user_Input {
    public static void main(String[] args) {        // write main and enter
        System.out.println("It Works");             // write sout and enter
        Scanner sc = new Scanner(System.in);         // making object of scanner class and System.in takes input from system
        System.out.println("Enter Number 1");
//        int a = sc.nextInt();                         // now entered number will come into variable a
        float a = sc.nextFloat();                       // for float nextfloat
...
//        int sum = a + b;
        ...
        String str1 = sc.nextLine();                     // scan full line
